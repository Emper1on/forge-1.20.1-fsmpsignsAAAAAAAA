package net.emperion.fsmpsigns;
...
@Mod(fsmpSigns.MOD_ID)
public class fsmpSigns
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "fsmpsigns";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    public fsmpSigns(FMLJavaModLoadingContext context)
    {
    ...
    public static class ClientModEvents
    {
        ...
        {
            Sheets.addWoodType(ModWoodTypes.FLOWER);
